...
const Navbar = ({ toggleSidebar, isCollapsed }) => {
    ...
    return (
        <header className={`fixed top-0 right-0 left-0 h-16 bg-white/90 backdrop-blur-sm border-b border-slate-100 flex items-center justify-between px-4 lg:px-8 z-30 transition-all duration-300 ${isCollapsed ? 'md:left-20' : 'md:left-64'}`}>
